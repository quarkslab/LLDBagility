...
hdiutil create -o "/tmp/macos-mojave.cdr" -size 6g -layout SPUD -fs HFS+J

hdiutil attach "/tmp/macos-mojave.cdr.dmg" -mountpoint "/Volumes/macos-mojave-installmedia"
sudo "/Applications/Install macOS Mojave.app/Contents/Resources/createinstallmedia" --volume "/Volumes/macos-mojave-installmedia"
